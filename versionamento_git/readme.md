...
* Em 2002 o projeto do núcleo(kernel) do Linux, que é open source, começa a utilizar o BitKeeper, DVCS proprietário.

* Em 2005 após conflitos com a comunidade, o BitKeeper rescinde a lincença gratuita. O que levou Linus Torvals, criador do Linux, e sua equipe a criar sua própria ferramenta, o **Git**.

**Fluxo básico**

* git clone: Realiza a cópia remota(upstream) do projeto.

* git pull: Realliza a atualização do repositório local

* git add .: Adiciona os arquivos para stage area, passo anterior do commit.
...
* 2018 foi vítima de um dos maiores ataques(até o momento) de DDos(ataque distribuído de negação de serviço)

* No mesmo ano comprado pela Microsoft Corporation por US $7,5 bilhões.

**Fluxo básico**

Ele básicamente funciona como nosso repositório remoto.
...
As configurações do GIT são armazenadas no arquivo **.gitconfig** localizado dentro do diretório do usuário do Sistema Operacional (Ex.: Windows: C:\Users\Documents and Settings\sandrolax ou *nix /home/sandrolax).

As configurações realizadas através dos comandos abaixo serão incluídas no arquivo citado acima.

##### Setar usuário
	git config --global user.name "Sandrolax Ramos"

##### Setar email
	git config --global user.email sandrolax@gmail.com
